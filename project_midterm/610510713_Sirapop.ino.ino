...
byte noPins = 2;              // Number of buttons/LEDs (While working on this, I was using only 2 LEDs)
                              // You could make the game harder by adding an additional LED/button/resistors combination.
byte pins[] = {10, 13}; // Button input pins and LED ouput pins - change these vaules if you wwant to connect yourbuttons to other pins
